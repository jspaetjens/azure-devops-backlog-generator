...
| 1.21 | 2026-08-31 | Draft | Jack Spaetjens | Defined the approved Application/Run Slice 2 configuration-bootstrap contract. |
...
Application/Run phase is not yet complete.
