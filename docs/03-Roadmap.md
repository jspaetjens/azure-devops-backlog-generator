...
| 1.20 | 2026-08-31 | Draft | Jack Spaetjens | Synchronized implemented Application/Run Slice 1 status while retaining subsequent application/run, readiness and review work. |
...
Gate 3. The wider Application/Run phase is not yet complete.
